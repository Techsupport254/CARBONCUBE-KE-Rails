class SendShopIdentityWhatsAppJob < ApplicationJob
  ...
  def perform(seller_email)
    Rails.logger.info "=== SHOP IDENTITY WHATSAPP JOB START ==="
    ...
    unless seller_email == 'optisoftkenya@gmail.com'
      ...
      Rails.logger.info "=== SHOP IDENTITY WHATSAPP JOB SKIPPED ==="
      return
    end
    ...
    if seller.nil?
      ...
      Rails.logger.error "=== SHOP IDENTITY WHATSAPP JOB FAILED ==="
      return
    end
    ...
    begin
      ...
      if seller.phone_number.present?
        ...
        # Send the shop_identity template (Swahili language)
      ...
      if sent_channels.any?
        ...
        Rails.logger.info "=== SHOP IDENTITY WHATSAPP JOB COMPLETED ==="
      else
