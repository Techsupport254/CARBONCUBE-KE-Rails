class DataDeletionMailer < ApplicationMailer
  ...
  def admin_notification
    ...
    mail(
      ...
      subject: "New Data Deletion Request - #{deletion_request.account_type.capitalize} Account",
      reply_to: deletion_request.email,
      react: {
  ...
  def status_update
    ...
    mail(
      to: deletion_request.email,
      subject: "Data Deletion Request Update - #{deletion_request.status.capitalize}",
      react: {
        name: deletion_request.full_name,
        email: deletion_request.email,
