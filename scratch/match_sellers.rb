...
puts "Found #{numbers_with_names.size} unique normalized phone numbers in call logs."
...
puts "\n--- MATCHED SELLERS ON PLATFORM (#{matched_sellers.size}) ---"
...
out_path = "/Users/user/Desktop/work/matched_sellers.json"
require 'json'
