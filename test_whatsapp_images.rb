#!/usr/bin/env ruby
# Test script for WhatsApp image upload functionality
...
def main
  log("=" * 50, GREEN)
  log("WhatsApp Image Upload Test", GREEN)
  log("=" * 50, GREEN)
  log("")
  ...
  # Step 7: Send CONFIRM to create product
  log("Step 7: Confirming product creation", YELLOW)
  log("-" * 50, YELLOW)
  ...
  # Step 8: Check if product was created
  log("Step 8: Verifying product creation", YELLOW)
  log("-" * 50, YELLOW)
  ...
  if session.status == 'completed'
    ...
    if recent_ad
      ...
      log("  Price: #{recent_ad.price}", GREEN)
