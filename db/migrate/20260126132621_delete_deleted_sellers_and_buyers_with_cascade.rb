class DeleteDeletedSellersAndBuyersWithCascade < ActiveRecord::Migration[7.1]
  def up
    ...
    if deleted_sellers_count > 0
      ...
      puts "Deleting ad-related records for deleted sellers..."
